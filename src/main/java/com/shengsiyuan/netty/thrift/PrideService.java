...
public class PrideService {
  ...
  public interface Iface {
    ...
    public Pride getPrideByUsername(String username) throws DaoException, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void getPrideByUsername(String username, org.apache.thrift.async.AsyncMethodCallback<Pride> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_getPrideByUsername(String username) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getPrideByUsername_call extends org.apache.thrift.async.TAsyncMethodCall<Pride> {
      ...
      public getPrideByUsername_call(String username, org.apache.thrift.async.AsyncMethodCallback<Pride> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class getPrideByUsername_args implements org.apache.thrift.TBase<getPrideByUsername_args, getPrideByUsername_args._Fields>, java.io.Serializable, Cloneable, Comparable<getPrideByUsername_args>   {
    ...
    public getPrideByUsername_args setUsername(String username) {
      this.username = username;
      return this;
    }
    ...
    public String toString() {
      StringBuilder sb = new StringBuilder("getPrideByUsername_args(");
      boolean first = true;
  ...
  public static class getPrideByUsername_result implements org.apache.thrift.TBase<getPrideByUsername_result, getPrideByUsername_result._Fields>, java.io.Serializable, Cloneable, Comparable<getPrideByUsername_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getPrideByUsername_result(");
      boolean first = true;
  ...
  public static class savePride_args implements org.apache.thrift.TBase<savePride_args, savePride_args._Fields>, java.io.Serializable, Cloneable, Comparable<savePride_args>   {
    ...
    public int compareTo(savePride_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetPride()).compareTo(other.isSetPride());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetPride()) {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("savePride_args(");
      boolean first = true;
  ...
  public static class savePride_result implements org.apache.thrift.TBase<savePride_result, savePride_result._Fields>, java.io.Serializable, Cloneable, Comparable<savePride_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("savePride_result(");
      boolean first = true;
